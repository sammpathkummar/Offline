...
{  
    ...
    save (user: user) 
	{
    	...
    	let options = new RequestOptions({ headers: queryHeaders });
			...
			return this.httpService.http.post('http://api.zen.com.my/api/v2/zenpoc/_table/user/', user.toJson(true),options)
			.map((data) => {
				return data;
			});
    ...
    query(params?: URLSearchParams): Observable<user[]> 
	{
    	...
    	queryHeaders.append('X-Dreamfactory-API-Key', "a7b6d4c78c4f5280f861fd14d62b01f955f867f98f2bc4bf87ae8c71689263d7");  
		return this.http
			.get("http://api.zen.com.my/api/v2/zenpoc/_table/user?api_key=a7b6d4c78c4f5280f861fd14d62b01f955f867f98f2bc4bf87ae8c71689263d7")
			.map((response) => {
